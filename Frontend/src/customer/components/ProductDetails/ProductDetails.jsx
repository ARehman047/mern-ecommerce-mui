    ...
    return (
        <div className="bg-white">
            <div className="pt-6">
                ...
                {loading ? <div className='min-h-64'>loading...</div>: <section className='grid grid-cols-1 lg:grid-cols-2'>
                    {/* Image gallery */}
                    <div className="flex flex-col items-center mt-10">
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center mt-5">
                            {product?.images?.map((item) => <div className='overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem]'>
                                <img
                                    alt={item.alt}
                                    src={item.src}
                                    className="h-full w-full object-cover object-center"
                    ...
                    <div className="max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-[35rem] lg:grid-cols-1 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                        <div className="lg:col-span-2 lg:pr-8">
                            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl">{actual_product?.brand}</h1>
                            <h2 className="text-gray-900 opacity-50 mt-5">{actual_product?.title}</h2>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 mt-5'>
                                <p className='font-semibold'>${actual_product?.discountedPrice}</p>
                                <p className='line-through opacity-60'>${actual_product?.price}</p>
                                <p className='text-green-700 font-semibold'>{actual_product?.discountPercent}% off</p>
                            </div>
                            ...
                            <div className="mt-6">
                                <div className='flex space-x-5 items-center'>
                                    ...
                                    <p className='cursor-pointer font-semibold text-sm text-purple-800 hover:text-purple-950'>200 Reviews</p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex flex-col mt-8 space-y-4'>
                                    <Grid2 container spacing={2} alignItems={"center"}>
                                        ...
                                        <Grid2 size={6}>
                                            <LinearProgress sx={{ bgcolor: "light-gray", borderRadius: 4, height: 5 }} color='success' variant="determinate" value={50} />
                                        </Grid2>
                                        <Grid2 size={3}>
                                    ...
                                    <Grid2 container spacing={2} alignItems={"center"}>
                                        ...
                                        <Grid2 size={6}>
                                            <LinearProgress sx={{ bgcolor: "light-gray", borderRadius: 4, height: 5 }} color='success' variant="determinate" value={40} />
                                        </Grid2>
                                        <Grid2 size={3}>
                                    ...
                                    <Grid2 container spacing={2} alignItems={"center"}>
                                        ...
                                        <Grid2 size={6}>
                                            <LinearProgress sx={{ bgcolor: "light-gray", borderRadius: 4, height: 5 }} color='primary' variant="determinate" value={30} />
                                        </Grid2>
                                        <Grid2 size={3}>
                                    ...
                                    <Grid2 container spacing={2} alignItems={"center"}>
                                        ...
                                        <Grid2 size={6}>
                                            <LinearProgress sx={{ bgcolor: "light-gray", borderRadius: 4, height: 5 }} color='warning' variant="determinate" value={20} />
                                        </Grid2>
                                        <Grid2 size={3}>
                                    ...
                                    <Grid2 container spacing={2} alignItems={"center"}>
                                        ...
                                        <Grid2 size={6}>
                                            <LinearProgress sx={{ bgcolor: "light-gray", borderRadius: 4, height: 5 }} color='error' variant="determinate" value={10} />
                                        </Grid2>
                                        <Grid2 size={3}>
